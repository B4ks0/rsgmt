...
urlpatterns = [
    ...
    path("paket-mcu/", views.mcu_package_list, name="mcu_package_list"),
    path("paket-mcu/<slug:slug>/", views.mcu_package_detail, name="mcu_package_detail"),
    ...
    path("dashboard/paket-mcu/", views.backend_mcu_package_list, name="backend_mcu_package_list"),
    path("dashboard/paket-mcu/add/", views.backend_mcu_package_create, name="backend_mcu_package_create"),
    path("dashboard/paket-mcu/<int:package_id>/edit/", views.backend_mcu_package_edit, name="backend_mcu_package_edit"),
    path("dashboard/paket-mcu/<int:package_id>/delete/", views.backend_mcu_package_delete, name="backend_mcu_package_delete"),
    path("dashboard/partners/", views.backend_partner_list, name="backend_partner_list"),
    path("dashboard/partners/add/", views.backend_partner_create, name="backend_partner_create"),
    path("dashboard/partners/<int:partner_id>/edit/", views.backend_partner_edit, name="backend_partner_edit"),
    path("dashboard/partners/<int:partner_id>/delete/", views.backend_partner_delete, name="backend_partner_delete"),
